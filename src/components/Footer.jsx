                    ...
                    <div className='sobreMiExplicacion'>
                        ...
                        <div className='redSocial'>
                            ...
                            <div className='iconosRedSocial'>
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="currentColor" className="bi bi-linkedin fotoSocial" viewBox="0 0 16 16">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="currentColor" className="bi bi-github fotoSocial" viewBox="0 0 16 16">
